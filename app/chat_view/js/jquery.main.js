...
(function( $ ) {
  ...
  var xhr_dlogin = $.get("app/chat_view/views/dialog-login.html", function (dialog_login) {
    $( "body" ).append( dialog_login );
  });

  var xhr_toolbar = $.get("app/chat_view/views/toolbar.html", function (toolbar) {
    $( "body" ).append( toolbar );
  });
  
  var xhr_mchat = $.get( "app/chat_view/views/main-chat.html", function( main_chat ) {
    $( "body" ).append( main_chat );
  });

  var xhr_options = $.get("app/chat_view/views/options.html", function (options) {
    $( "body" ).append( options );
  });
